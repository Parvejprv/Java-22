...
public class SubstractionIn2DArrays {
    ...
    public static void main(String[] args) {
        ...
        // sub of the 2 two dimensional array 
        for(int i=0; i<row; i++){
             for(int j=0; j<col; j++){
...
//        }
          ...
          // Displaying array using the for-each loop
    ...
    Enter the col size:
    2
    Enter the input element into the 1st array of size 2x2 matrix: 
    1 2
    3 4
    Enter the input element into the 2nd array of size 2x2 matrix: 
    1 2
    3 4
    Resultant Matrix is: 
    0 0 
    ...
    */
    ...
    /*
    // Subtracting two matrices statically
    // -------------------------------
    public static void main(String[] args) {
         ...
         // Substracting these 2 two dimensional array A[][] and B[][]
